# batman = Article.create! title: "Batman", description: <<-ARTICLE
...
# superman = Article.create! title: "Superman", description: <<-ARTICLE
...
# krypton = Article.create! title: "Krypton", description: <<-ARTICLE
...
# lex_luthor = Article.create! title: "Lex Luthor", description: <<-ARTICLE
...
# robin = Article.create! title: "Robin", description: <<-ARTICLE
...
portfolio = Category.create(name: 'Portfolio')
projecten = Category.create(name: 'Projecten')


Titeltje  = Article.new(title: 'rug', description: 'mega')
rug.category = photo
rug.save!

Schoteltje = Article.new(title: 'bowl', description: 'leuk' )
bowl.category = portfolio
bowl.save!
